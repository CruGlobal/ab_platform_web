export default function FNAbviewcontainerComponent({
   /*AB,*/
   ABViewComponentPlugin,
}) {
   return class ABAbviewcontainerComponent extends ABViewComponentPlugin {
      ...
      async init(AB, accessLevel = 0, options = {}) {
         ...
         for (const key in viewComponents) {
            ...
            if (accessLevel) {
               allInits.push(
                  viewComponents[key].init(AB, accessLevel, options),
               );
