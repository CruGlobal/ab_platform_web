...
export default function FNAbviewchart({
   ...
   const ABAbviewchartComponent = FNAbviewchartComponent({ ABViewComponentPlugin });
   ...
   class ABViewChartCore extends ABViewChartContainer {
   ...
   return class ABViewChart extends ABViewChartCore {
       ...
       */
      component() {
         return new ABAbviewchartComponent(this);
      }
